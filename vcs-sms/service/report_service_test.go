...
func TestSendReport(t *testing.T) {
	...
	service := NewReportService(NewESService(&repo.ESClient{Client: elasticsearch.GetESClient()}),
		NewRegisteredMailService(),
		NewServerService(sql.GetPostgres()),
		NewCacheService(cache.GetRedis()),
	)
